...
### 1. Ray-tracing
A custom ray-tracing engine has been developed to render triangular meshes. It supports three types of textures: Lambertian, metal, and glass, with recursive ray tracing for handling reflections and refractions.
![](reflection.png "metal")
![](glass.png "glass")
...
<div style="display: flex; justify-content: space-around;">
  <div>
    <img src="Gandalf.png" alt="Gandalf" title="Gandalf" style="width: 93%;">
    <p align="center">Gandalf</p>
  </div>
  <div>
    <img src="Balrog.png" alt="Balrog" title="Balrog" style="width: 97%;">
...
<div style="display: flex; justify-content: space-around;">
  <div>
    <img src="bump_before.png" alt="Before" title="Before" style="width: 98%;">
    <p align="center">Before</p>
  </div>
  <div>
    <img src="bump_after.png" alt="After" title="After" style="width: 96%;">
    <p align="center">After</p>
  </div>
</div>

### 5. Fire simulation dynamic
